...
class OEWC:
    ...
    def __init__(self):
        """
        Initialize OEWC Class and compute fisher matrix based on previous model and sample data. 
        """
    ...
    def retrain(self, model, data_samples, epochs, loss_fn, optimizer, train_set, test_set=None, num_samples=30, lambda_=0.1, gamma=1.):
        """
        ...
        def oewc_loss_fn(y_true, y_pred):
            loss = loss_fn(y_true, y_pred)
            penalty = 0.
            for f, v, w in zip(self.fisher_matrix, model.weights, prior_weights):
